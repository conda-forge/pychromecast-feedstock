...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pychromecast-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pychromecast-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pychromecast
# for installing globally
pixi global install pychromecast
```
...
It is possible to list all of the versions of `pychromecast` available on your platform:
...
```
pixi search pychromecast --channel conda-forge
```
